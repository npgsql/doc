...
* Set up a replication in your [`pg_hba.conf`](https://www.postgresql.org/docs/current/auth-pg-hba-conf.html) file:
...
To use `test_decoding`, create a logical replication slot with `test_decoding` as the plugin type, and use the following:
