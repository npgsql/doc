...
geom.Buffer(d)                   | [ST_Buffer(geom,d)](https://postgis.net/docs/manual-3.0/ST_Buffer.html)
geom.Centroid                    | [ST_Centroid(geom)](https://postgis.net/docs/manual-3.0/ST_Centroid.html)
...
linestring.Count                 | [ST_NumPoints(linestring)](https://postgis.net/docs/manual-3.0/ST_NumPoints.html)
geom1.ConvexHull()               | [ST_ConvexHull(geom1)](https://postgis.net/docs/manual-3.0/ST_ConvexHull.html)
...
geom1.ExactEquals(geom2)         | [ST_OrderingEquals(geom1, geom2)](https://postgis.net/docs/manual-3.0/ST_OrderingEquals.html)
...
linestring.GetPointN(i)          | [ST_PointN(linestring, i)](https://postgis.net/docs/manual-3.0/ST_PointN.html)
geom1.Intersection(geom2)        | [ST_Intersection(geom1, geom2)](https://postgis.net/docs/manual-3.0/ST_Intersection.html)
geom1.Intersects(geom2)          | [ST_Intersects(geom1, geom2)](https://postgis.net/docs/manual-3.0/ST_Intersects.html)
...
geom.IsWithinDistance(geom2,d)   | [ST_DWithin(geom1,geom2,d)](https://postgis.net/docs/manual-3.0/ST_DWithin.html)
...
geom.Normalized                  | [ST_Normalize(geom)](https://postgis.net/docs/manual-3.0/ST_Normalize.html)
