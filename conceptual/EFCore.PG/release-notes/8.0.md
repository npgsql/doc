...
On to the code! You can now use any LINQ operator - or chain of operators - on top of an array or list property. For example, the following queries for all blogs who have at least 3 tags starting with "x":
