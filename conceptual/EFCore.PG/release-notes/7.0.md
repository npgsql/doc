...
* Fully standardized logging via Microsoft.Extensions.Logging, including a new [Npgsql.DependencyInjection](https://learn.microsoft.com/en-us/dotnet/core/extensions/logging?tabs=command-line)
